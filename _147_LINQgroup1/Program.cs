...
namespace _147_LINQgroup1
{
    ...
    {
        /// <summary>
        /// <para>LINQ: group ~ by ~ into</para>
        /// <para>
        ///     group "그룹화될 요소" by "그룹화할 기준"으로 그룹화,
        ///     그룹화된 요소 각각에는 Key Prop이 생기는 걸로 추정됨
        /// </para>
        /// <para>
        ///     굳이 분리해서 볼 이유는 안 보이지만 해당 과정 역시
        ///     group 과정에서 생긴 Key를 토대로 작동하고 있음
        /// </para>
        /// </summary>
